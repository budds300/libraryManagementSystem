...
urlpatterns = [
    ...
    path('delete_book/<str:pk>/', views.delete_book, name="delete_books"),
    path('update_book/<str:pk>/', views.update_book, name="update_books"),
    path('book/<book_id>/',views.view_admin_book,name ='single_book'),
    path('books/<book_id>/',views.view_available_book,name ='available_book'),
